...
.pf-c-table {
  ...
  --pf-c-table--tr--m-hoverable--hover--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tr--m-hoverable--hover--BackgroundColor: var(--pf-global--BackgroundColor--100);
  --pf-c-table--tr--m-hoverable--focus--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tr--m-hoverable--focus--BackgroundColor: var(--pf-global--BackgroundColor--100);
  --pf-c-table--tr--m-hoverable--active--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  ...
  --pf-c-table--tr--m-selected--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  ...
  --pf-c-table--tr--m-selected--m-selected--m-hoverable--hover--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tr--m-selected--m-hoverable--hover--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tr--m-selected--m-hoverable--hover--m-selected--BoxShadow: var(--pf-global--BoxShadow--sm-bottom) inset, var(--pf-global--BoxShadow--sm-bottom);
  ...
  --pf-c-table--tbody--m-hoverable--hover--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tbody--m-hoverable--hover--BackgroundColor: var(--pf-global--BackgroundColor--100);
  --pf-c-table--tbody--m-hoverable--focus--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tbody--m-hoverable--focus--BackgroundColor: var(--pf-global--BackgroundColor--100);
  --pf-c-table--tbody--m-hoverable--active--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  ...
  --pf-c-table--tbody--m-selected--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  ...
  --pf-c-table--tbody--m-selected--m-selected--m-hoverable--hover--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tbody--m-selected--m-hoverable--hover--BoxShadow: var(--pf-global--BoxShadow--sm-top), var(--pf-global--BoxShadow--sm-bottom);
  --pf-c-table--tbody--m-selected--m-hoverable--hover--m-selected--BoxShadow: var(--pf-global--BoxShadow--sm-bottom) inset, var(--pf-global--BoxShadow--sm-bottom);
  ...
  .pf-c-table tr.pf-m-selected {
    ...
    .pf-c-table tr.pf-m-selected.pf-m-hoverable:hover {
      box-shadow: var(--pf-c-table--tr--m-selected--m-hoverable--hover--BoxShadow); }
    .pf-c-table tr.pf-m-selected.pf-m-hoverable:hover + tr.pf-m-selected {
      box-shadow: var(--pf-c-table--tr--m-selected--m-hoverable--hover--m-selected--BoxShadow); }
    .pf-c-table tr.pf-m-selected + tr.pf-m-selected.pf-m-hoverable:hover {
      box-shadow: var(--pf-c-table--tr--m-selected--m-selected--m-hoverable--hover--BoxShadow); }
  ...
  .pf-c-table tbody.pf-m-selected {
    --pf-c-table__expandable-row--after--BorderLeftWidth: var(--pf-c-table--tbody--m-expanded--m-selected--BorderLeftWidth);
    --pf-c-table__expandable-row--after--BorderColor: var(--pf-c-table--tbody--m-expanded--m-selected--BorderColor);
    ...
    .pf-c-table tbody.pf-m-selected.pf-m-hoverable:hover {
      --pf-c-table--tbody--m-selected--BoxShadow: var(--pf-c-table--tbody--m-selected--m-hoverable--hover--BoxShadow); }
    .pf-c-table tbody.pf-m-selected.pf-m-hoverable:hover + tbody.pf-m-selected {
      --pf-c-table--tbody--m-selected--BoxShadow: var(--pf-c-table--tbody--m-selected--m-hoverable--hover--m-selected--BoxShadow); }
    .pf-c-table tbody.pf-m-selected + tbody.pf-m-selected.pf-m-hoverable:hover {
      --pf-c-table--tbody--m-selected--BoxShadow: var(--pf-c-table--tbody--m-selected--m-selected--m-hoverable--hover--BoxShadow); }

        ...
        React.createElement(InputGroup, null,
            React.createElement("div", { className: css(styles.searchInputBar) },
                React.createElement("span", { className: css(styles.searchInputText) },
                    ...
                    React.createElement("input", { ref: innerRef, className: css(styles.searchInputTextInput), value: searchValue, placeholder: placeholder, "aria-label": ariaLabel, onChange: onChangeHandler })),
                value && (React.createElement("span", { className: css(styles.searchInputUtilities) },
                    ...
                    !!onClear && (React.createElement("span", { className: "pf-c-search-input__clear" },
                        React.createElement(Button, { variant: ButtonVariant.plain, "aria-label": resetButtonLabel, onClick: onClear },
                            React.createElement(TimesIcon, null))))))),
            attributes.length > 0 && (React.createElement(React.Fragment, null,
                React.createElement(Button, { className: showSearchMenu && 'pf-m-expanded', variant: ButtonVariant.control, "aria-label": openMenuButtonAriaLabel, onClick: onToggle, "aria-expanded": showSearchMenu },
                    React.createElement(CaretDownIcon, null)),
                !!onSearch && (React.createElement(Button, { type: "submit", variant: ButtonVariant.control, "aria-label": submitSearchButtonLabel, onClick: onSearchHandler },
                    React.createElement(ArrowRightIcon, null)))))),
        attributes.length > 0 && showSearchMenu && (React.createElement("div", { className: css(styles.searchInputMenu) },

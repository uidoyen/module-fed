...
export const DrawerPanelContent = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ id: id, className: css(styles.drawerPanel, isResizable && styles.modifiers.resizable, hasNoBorder && styles.modifiers.noBorder, formatBreakpointMods(widths, styles), className), ref: panel, onTransitionEnd: ev => {

...
exports.TreeView = (_a) => {
    ...
    return (React.createElement(React.Fragment, null, parentItem ? (treeViewList) : (React.createElement(TreeViewRoot_1.TreeViewRoot, Object.assign({ hasChecks: hasChecks }, props), treeViewList))));
};

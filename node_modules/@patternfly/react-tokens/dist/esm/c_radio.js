export const c_radio = {
  ".pf-c-radio": {
    ...
    "c_radio__input_Height": {
      ...
      "value": "calc(1rem * 1.3)",
      "values": [
        "calc(--pf-c-radio__label--FontSize * --pf-c-radio__label--LineHeight)",
        "calc(--pf-global--FontSize--md * --pf-global--LineHeight--sm)",
        "calc($pf-global--FontSize--md * $pf-global--LineHeight--sm)",
        "calc(pf-font-prem(16px) * 1.3)",
        "calc(1rem * 1.3)"
      ]
    },
    "c_radio__input_MarginTop": {
      "name": "--pf-c-radio__input--MarginTop",
      "value": "calc(-1px * (1.3 * 1.25))",
      "values": [
        "calc(-1px * (--pf-c-radio__label--LineHeight * 1.25))",
        "calc(-1px * (--pf-global--LineHeight--sm * 1.25))",
        "calc(-1px * ($pf-global--LineHeight--sm * 1.25))",
        "calc(-1px * (1.3 * 1.25))"
      ]
    },
